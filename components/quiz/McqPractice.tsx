...
import MathInline from "@/components/quiz/MathInline";
import type {
  PracticeQuestion,
  PracticeSetStats,
...
const QuizCalculator = dynamic(() => import("@/components/quiz/QuizCalculator"), {
  ssr: false,
  loading: () => null,
});
...
export default function McqPractice({
  ...
  const [timeLeft, setTimeLeft] = useState(setStats.estimatedMinutes * 60);
  ...
  // Calculator visibility (mathjs loads only when opened)
