...
export function EditCertificateModal({
  ...
  useEffect(() => {
    if (certificate) {
      ...
      const isStandardType = Object.keys(CERTIFICATE_DEFAULT_MESSAGES).includes(
      ...
      const persistedMessage = certificate.message || certificate.customMessage;
      setHasCustomMessage(!!certificate.hasCustomMessage || !isStandardType);

      if ((certificate.hasCustomMessage || !isStandardType) && persistedMessage) {
        ...
        setMessage(CERTIFICATE_DEFAULT_MESSAGES[certificate.certType] || "");
  ...
  function handleSubmit() {
    ...
    if ((hasCustomMessage || isCustom) && message.trim()) {
