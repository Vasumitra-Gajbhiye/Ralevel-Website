export function banAppealConfirmationEmail({
  name,
}: {
  name?: string | null;
}) {
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;border:1px solid #e2e8f0;padding:32px;">
            ...
            <tr>
              <td style="font-size:15px;color:#334155;padding-bottom:12px;">
                Thank you for submitting your ban appeal for the r/alevel Discord server.
                Our moderators will review it carefully.
              </td>
            </tr>

            <tr>
              <td style="font-size:14px;color:#475569;padding-top:8px;">
                You will be notified of the decision by email at this address.
                Please do not contact staff about the status of your appeal.
              </td>
            </tr>
            ...
            <tr>
              <td style="font-size:12px;color:#94a3b8;text-align:center;">
                ...
                If you did not submit this appeal, please ignore this message.
                <br/><br/>
